package cn.yshstudio.originalproduct.pages.view;
...
import cn.yshstudio.originalproduct.pages.view.pulltorefresh.interfaces.OnXScrollListener;
import cn.yshstudio.originalproduct.pages.view.pulltorefresh.view.PullToRefreshListFooter;
import cn.yshstudio.originalproduct.pages.view.pulltorefresh.view.PullToRefreshListHeader;
import cn.yshstudio.originalproduct.pages.view.swipemenu.adapter.SwipeMenuAdapter;
...
import cn.yshstudio.originalproduct.pages.view.swipemenu.interfaces.OnSwipeListener;
import cn.yshstudio.originalproduct.pages.view.swipemenu.interfaces.SwipeMenuCreator;
import cn.yshstudio.originalproduct.pages.view.swipemenu.view.SwipeMenuLayout;
...
public class PullToRefreshSwipeMenuListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private cn.yshstudio.originalproduct.pages.view.swipemenu.view.SwipeMenuLayout mTouchView;
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (view instanceof SwipeMenuLayout) {
                    mTouchView = (cn.yshstudio.originalproduct.pages.view.swipemenu.view.SwipeMenuLayout) view;
                }
                if (mTouchView != null) {
                    mTouchView.onSwipe(ev);
                }
